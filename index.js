...
function closeSidebar() {
    ...
    tl.to(sidebarDropdownContent, { duration: 0.3, height: 0, ease: "none"});
    tl.set(sidebarDropdownContent, { visibility: "hidden",});
    tl.to(sidebar, { duration: 0.3, top: parseFloat(sidebarTopValue), ease: "none"}, "-=0.3");
...
function openSidebarDropdown() {
    ...
    tl.to(sidebarDropdownContent, {duration: 0.3, height: "auto", ease: "none"});
}
